"""MCP server for simple hello world
        ...
        contents=[
            types.TextResourceContents(
                ...
                _meta={
                    ...
                    "openai/widgetDescription": "Hello World interactive display"
                }
            )
        ]
    )
...
async def _list_tools() -> List[types.Tool]:
    ...
    return [
        types.Tool(
            name="say_hello",
            title="Say Hello",
            description="Display a friendly hello world greeting with optional personalization",
            inputSchema={
                "type": "object",
                "properties": {
                    "name": {
            ...
            _meta={
                ...
                "openai/toolInvocation/invoked": "Hello displayed!",
...
async def _call_tool_request(
    ...
    if tool_name == "say_hello":
        ...
        data = {
            ...
            "name": name,
            "timestamp": "now",
            "message": "Welcome to this simple hello world example!"
        }
        ...
        return types.CallToolResult(
            content=[
                types.TextContent(
                    type="text",
                    text=f"{greeting} Here's your personalized greeting displayed in the interactive component below.",
                )
            ],
            structuredContent={
                "greeting": greeting,
